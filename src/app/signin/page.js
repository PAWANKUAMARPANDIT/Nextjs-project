...
const SignInPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 to-purple-100 py-16 px-4 sm:px-6 lg:px-8 flex items-center">
      <div className="max-w-md w-full mx-auto space-y-8 bg-white p-10 rounded-xl shadow-2xl transform transition-all hover:scale-105">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <Link href="/signup" className="font-medium text-indigo-600 hover:text500">
              Sign up
            </Link>
          </p>
        </div>
